...
SitAd.prototype.style = function() {
  ...
  css += '#one {position:absolute;left:15px;top:32px;transition:opacity 1s;-webkit-transition: opacity 1s;opacity:1} #two{position:absolute;left:15px;top:50px;transition:opacity 1s;-webkit-transition: opacity 1s;opacity:0}'
...
SitAd.prototype.events = function() {
  var self = this
  setTimeout(function() {
      document.getElementById('bg').style.left = '-33px'
